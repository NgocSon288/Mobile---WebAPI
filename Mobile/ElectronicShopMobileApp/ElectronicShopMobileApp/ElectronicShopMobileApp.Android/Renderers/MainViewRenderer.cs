...
using ElectronicShopMobileApp.Droid.Renderers;
using ElectronicShopMobileApp.Views;
using ElectronicShopMobileApp.Views.Core;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using Color = Android.Graphics.Color;

[assembly: ExportRenderer(typeof(MainViewPage), typeof(MainViewRenderer))]
namespace ElectronicShopMobileApp.Droid.Renderers
{
    public class MainViewRenderer : VisualElementRenderer<MainViewPage>, IOnTabClickListener
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<MainViewPage> e)
        {
        ...
        private void InitializeElement(MainViewPage element)
        {
            PopulateChildren(element);
        }

        private void PopulateChildren(MainViewPage element)
        {
        ...
        private void ClearElement(MainViewPage element)
        {
            if (_currentPage != null)
            {
